function Menu() {
  ...
  this.show = function() {
    ...
    textSize(10)
      ...
      textAlign(CENTER)
      fill(this.fade1)
      text("current level: " + mn.level, 3 * w / 4, 2 * h / 3 + h / 30)
    textAlign(CENTER, CENTER)
    textSize(11)   
...
var play = new Button("play", 3 * w / 4 - w / 12, h / 3 - h / 20, w / 6, h / 10, 30, false, false)
...
var mutebutton = new Button("music volume: ", w / 2 - w / 20, 7 * h / 8, w / 10, h / 20, 11, true, true)
var sfxmutebutton = new Button("sfx volume: ", w / 2 - w / 20, 7 * h / 8 + sclY(20), w / 10, h / 20, 11, true, true)
var levelSelectorButton = new Button("select a level", 3 * w / 4 - w / 12 , 2 * h / 3 - h / 20, w / 6,  h / 10, 15, false, false)
