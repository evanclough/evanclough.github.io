...
function Flag() {
  ...
  this.show = function() {
    ...
    image(flagimage, this.x - 10, this.y - 10, 20, 20);
  }
  this.update = function() {
    if (p.hasFlag) {
      this.x = p.x + 7.5;
...
function slowzone(x, y, xs, ys) {
  ...
  this.show = function() {
    fill(255, 168, 69);
    image(slowzonegradient, this.x, this.y, this.xs, this.ys);
...
function Wall(x1, y1, x2, y2, type, isDifferentColor) {
  this.x1 = x1;
  this.x2 = x2;
  this.y1 = y1;
  this.y2 = y2;
...
var lvl8_1 = new Wall(650, 100, 700, 100, "x", true);
var lvl8_2 = new Wall(700, 100, 700, 150, "y", true);
function Bait(x, y) {
  this.x = x;
  this.y = y;
  this.r = 10;
